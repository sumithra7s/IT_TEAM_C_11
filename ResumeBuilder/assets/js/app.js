...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    certiDsp = document.getElementById('certi_dsp'),
    areaDsp = document.getElementById('area_dsp'),
...
const getUserInputs = () => {
    ...
    let certiElem = document.querySelectorAll('.certi');
    let areaElem = document.querySelectorAll('.area');
    ...
    certiElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'certi')));
    areaElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'area')));
    ...
    return {
        ...
        certi: fetchValues(['certi'], certiElem),
        area: fetchValues(['area'], areaElem)
    }
};
...
const displayCV = (userData) => {
    ...
    showListData(userData.certi, certiDsp);
    showListData(userData.area, areaDsp);
